...
class Box:
    ...
    @staticmethod
    def _put_text(img, text, org, fontFace=None, fontScale=1, color=(0,  0, 255),
    ...
    @staticmethod
    def put_box_text(img: Union[Sequence, np.ndarray], box: Union[Sequence, np.ndarray], label: Union[Sequence, str],
